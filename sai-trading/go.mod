module github.com/NibiruChain/nibiru/sai-trading

go 1.24.0

require github.com/NibiruChain/nibiru/v2 v2.8.0
...
require (
	...
	github.com/cosmos/cosmos-sdk v0.47.11-nibiru.5 // indirect
...
// Replace block for "github.com/NibiruChain/nibiru/v2"
