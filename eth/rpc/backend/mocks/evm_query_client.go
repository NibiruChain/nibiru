...
import (
	...
	evm "github.com/NibiruChain/nibiru/v2/x/evm"
...
func (_m *EVMQueryClient) Balance(ctx context.Context, in *evm.QueryBalanceRequest, opts ...grpc.CallOption) (*evm.QueryBalanceResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryBalanceRequest, ...grpc.CallOption) (*evm.QueryBalanceResponse, error)); ok {
...
func (_m *EVMQueryClient) EthAccount(ctx context.Context, in *evm.QueryEthAccountRequest, opts ...grpc.CallOption) (*evm.QueryEthAccountResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for EthAccount")
	}

	var r0 *evm.QueryEthAccountResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryEthAccountRequest, ...grpc.CallOption) (*evm.QueryEthAccountResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) EthCall(ctx context.Context, in *evm.EthCallRequest, opts ...grpc.CallOption) (*evm.MsgEthereumTxResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.EthCallRequest, ...grpc.CallOption) (*evm.MsgEthereumTxResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) FunTokenMapping(ctx context.Context, in *evm.QueryFunTokenMappingRequest, opts ...grpc.CallOption) (*evm.QueryFunTokenMappingResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for FunTokenMapping")
	}

	var r0 *evm.QueryFunTokenMappingResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryFunTokenMappingRequest, ...grpc.CallOption) (*evm.QueryFunTokenMappingResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) Params(ctx context.Context, in *evm.QueryParamsRequest, opts ...grpc.CallOption) (*evm.QueryParamsResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryParamsRequest, ...grpc.CallOption) (*evm.QueryParamsResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) Storage(ctx context.Context, in *evm.QueryStorageRequest, opts ...grpc.CallOption) (*evm.QueryStorageResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryStorageRequest, ...grpc.CallOption) (*evm.QueryStorageResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) TraceCall(ctx context.Context, in *evm.QueryTraceTxRequest, opts ...grpc.CallOption) (*evm.QueryTraceTxResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryTraceTxRequest, ...grpc.CallOption) (*evm.QueryTraceTxResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *EVMQueryClient) ValidatorAccount(ctx context.Context, in *evm.QueryValidatorAccountRequest, opts ...grpc.CallOption) (*evm.QueryValidatorAccountResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *evm.QueryValidatorAccountRequest, ...grpc.CallOption) (*evm.QueryValidatorAccountResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
