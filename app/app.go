...
func NewMatrixApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		authzkeeper.StoreKey, stabletypes.StoreKey,
	)
	...
	app.StableCoinKeeper = keeper.NewKeeper(
		appCodec,
		keys[stabletypes.StoreKey],
		app.BankKeeper,
	)
...
// Name returns the name of the MatrixApp
...
// InterfaceRegistry returns MatrixApp's InterfaceRegistry
