...
// Source: github.com/NibiruChain/nibiru/feeder (interfaces: PricePoster)
...
import (
	context "context"
	types2 "github.com/NibiruChain/nibiru/feeder/types"
	reflect "reflect"
...
func (m *MockPricePoster) SendPrices(arg0 context.Context, arg1 []types2.Price) chan struct{} {
	m.ctrl.T.Helper()
...
func (m *MockPricePoster) Whoami() types.ValAddress {
	m.ctrl.T.Helper()
