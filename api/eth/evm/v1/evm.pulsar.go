...
func (x *_Params_11_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*WasmPlugin)
	(*x.list)[i] = concreteValue
}
...
var (
	...
	fd_Params_canonical_wnibi     protoreflect.FieldDescriptor
	fd_Params_wasm_plugins        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_canonical_wnibi = md_Params.Fields().ByName("canonical_wnibi")
	fd_Params_wasm_plugins = md_Params.Fields().ByName("wasm_plugins")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CanonicalWnibi != "" {
		value := protoreflect.ValueOfString(x.CanonicalWnibi)
		if !f(fd_Params_canonical_wnibi, value) {
			return
		}
	}
	if len(x.WasmPlugins) != 0 {
		value := protoreflect.ValueOfList(&_Params_11_list{list: &x.WasmPlugins})
		if !f(fd_Params_wasm_plugins, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "eth.evm.v1.Params.canonical_wnibi":
		return x.CanonicalWnibi != ""
	case "eth.evm.v1.Params.wasm_plugins":
		return len(x.WasmPlugins) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.Params.create_funtoken_fee":
		...
		return protoreflect.ValueOfString(value)
	case "eth.evm.v1.Params.canonical_wnibi":
		value := x.CanonicalWnibi
		return protoreflect.ValueOfString(value)
	case "eth.evm.v1.Params.wasm_plugins":
		if len(x.WasmPlugins) == 0 {
			return protoreflect.ValueOfList(&_Params_11_list{})
		}
		listValue := &_Params_11_list{list: &x.WasmPlugins}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.Params"))
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "eth.evm.v1.Params.canonical_wnibi":
		x.CanonicalWnibi = value.Interface().(string)
	case "eth.evm.v1.Params.wasm_plugins":
		lv := value.List()
		clv := lv.(*_Params_11_list)
		x.WasmPlugins = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.Params.evm_channels":
		...
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.Params.wasm_plugins":
		if x.WasmPlugins == nil {
			x.WasmPlugins = []*WasmPlugin{}
		}
		value := &_Params_11_list{list: &x.WasmPlugins}
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.Params.create_funtoken_fee":
		panic(fmt.Errorf("field create_funtoken_fee of message eth.evm.v1.Params is not mutable"))
	case "eth.evm.v1.Params.canonical_wnibi":
		panic(fmt.Errorf("field canonical_wnibi of message eth.evm.v1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.CanonicalWnibi)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if len(x.WasmPlugins) > 0 {
			for _, e := range x.WasmPlugins {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.WasmPlugins) > 0 {
			for iNdEx := len(x.WasmPlugins) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.WasmPlugins[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.CanonicalWnibi) > 0 {
			i -= len(x.CanonicalWnibi)
			copy(dAtA[i:], x.CanonicalWnibi)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.CanonicalWnibi)))
			i--
			dAtA[i] = 0x52
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 10:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CanonicalWnibi", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CanonicalWnibi = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 11:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field WasmPlugins", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.WasmPlugins = append(x.WasmPlugins, &WasmPlugin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.WasmPlugins[len(x.WasmPlugins)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_WasmPlugin      protoreflect.MessageDescriptor
	fd_WasmPlugin_name protoreflect.FieldDescriptor
	fd_WasmPlugin_addr protoreflect.FieldDescriptor
)

func init() {
	file_eth_evm_v1_evm_proto_init()
	md_WasmPlugin = File_eth_evm_v1_evm_proto.Messages().ByName("WasmPlugin")
	fd_WasmPlugin_name = md_WasmPlugin.Fields().ByName("name")
	fd_WasmPlugin_addr = md_WasmPlugin.Fields().ByName("addr")
}

var _ protoreflect.Message = (*fastReflection_WasmPlugin)(nil)

type fastReflection_WasmPlugin WasmPlugin

func (x *WasmPlugin) ProtoReflect() protoreflect.Message {
	return (*fastReflection_WasmPlugin)(x)
}

func (x *WasmPlugin) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_WasmPlugin_messageType fastReflection_WasmPlugin_messageType
var _ protoreflect.MessageType = fastReflection_WasmPlugin_messageType{}

type fastReflection_WasmPlugin_messageType struct{}

func (x fastReflection_WasmPlugin_messageType) Zero() protoreflect.Message {
	return (*fastReflection_WasmPlugin)(nil)
}
func (x fastReflection_WasmPlugin_messageType) New() protoreflect.Message {
	return new(fastReflection_WasmPlugin)
}
func (x fastReflection_WasmPlugin_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_WasmPlugin
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_WasmPlugin) Descriptor() protoreflect.MessageDescriptor {
	return md_WasmPlugin
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_WasmPlugin) Type() protoreflect.MessageType {
	return _fastReflection_WasmPlugin_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_WasmPlugin) New() protoreflect.Message {
	return new(fastReflection_WasmPlugin)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_WasmPlugin) Interface() protoreflect.ProtoMessage {
	return (*WasmPlugin)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_WasmPlugin) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Name != "" {
		value := protoreflect.ValueOfString(x.Name)
		if !f(fd_WasmPlugin_name, value) {
			return
		}
	}
	if x.Addr != "" {
		value := protoreflect.ValueOfString(x.Addr)
		if !f(fd_WasmPlugin_addr, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_WasmPlugin) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
		return x.Name != ""
	case "eth.evm.v1.WasmPlugin.addr":
		return x.Addr != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.WasmPlugin"))
		}
		panic(fmt.Errorf("message eth.evm.v1.WasmPlugin does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WasmPlugin) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
		x.Name = ""
	case "eth.evm.v1.WasmPlugin.addr":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_WasmPlugin) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
		value := x.Name
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message eth.evm.v1.WasmPlugin does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WasmPlugin) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WasmPlugin) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
		panic(fmt.Errorf("field name of message eth.evm.v1.WasmPlugin is not mutable"))
	case "eth.evm.v1.WasmPlugin.addr":
		panic(fmt.Errorf("field addr of message eth.evm.v1.WasmPlugin is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.WasmPlugin"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_WasmPlugin) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.WasmPlugin.name":
		return protoreflect.ValueOfString("")
	case "eth.evm.v1.WasmPlugin.addr":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_WasmPlugin) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in eth.evm.v1.WasmPlugin", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_WasmPlugin) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WasmPlugin) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_WasmPlugin) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_WasmPlugin) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*WasmPlugin)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: WasmPlugin: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: WasmPlugin: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_LogLite_2_list)(nil)

type _LogLite_2_list struct {
	list *[]string
}

func (x *_LogLite_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_LogLite_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_LogLite_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_LogLite_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_LogLite_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message LogLite at list field Topics as it is not of Message kind"))
}

func (x *_LogLite_2_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_LogLite_2_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_LogLite_2_list) IsValid() bool {
	return x.list != nil
}

var (
	md_LogLite         protoreflect.MessageDescriptor
	fd_LogLite_address protoreflect.FieldDescriptor
	fd_LogLite_topics  protoreflect.FieldDescriptor
	fd_LogLite_data    protoreflect.FieldDescriptor
)

func init() {
	file_eth_evm_v1_evm_proto_init()
	md_LogLite = File_eth_evm_v1_evm_proto.Messages().ByName("LogLite")
	fd_LogLite_address = md_LogLite.Fields().ByName("address")
	fd_LogLite_topics = md_LogLite.Fields().ByName("topics")
	fd_LogLite_data = md_LogLite.Fields().ByName("data")
}

var _ protoreflect.Message = (*fastReflection_LogLite)(nil)

type fastReflection_LogLite LogLite

func (x *LogLite) ProtoReflect() protoreflect.Message {
	return (*fastReflection_LogLite)(x)
}

func (x *LogLite) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_LogLite_messageType fastReflection_LogLite_messageType
var _ protoreflect.MessageType = fastReflection_LogLite_messageType{}

type fastReflection_LogLite_messageType struct{}

func (x fastReflection_LogLite_messageType) Zero() protoreflect.Message {
	return (*fastReflection_LogLite)(nil)
}
func (x fastReflection_LogLite_messageType) New() protoreflect.Message {
	return new(fastReflection_LogLite)
}
func (x fastReflection_LogLite_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_LogLite
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_LogLite) Descriptor() protoreflect.MessageDescriptor {
	return md_LogLite
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_LogLite) Type() protoreflect.MessageType {
	return _fastReflection_LogLite_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_LogLite) New() protoreflect.Message {
	return new(fastReflection_LogLite)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_LogLite) Interface() protoreflect.ProtoMessage {
	return (*LogLite)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_LogLite) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_LogLite_address, value) {
			return
		}
	}
	if len(x.Topics) != 0 {
		value := protoreflect.ValueOfList(&_LogLite_2_list{list: &x.Topics})
		if !f(fd_LogLite_topics, value) {
			return
		}
	}
	if len(x.Data) != 0 {
		value := protoreflect.ValueOfBytes(x.Data)
		if !f(fd_LogLite_data, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_LogLite) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "eth.evm.v1.LogLite.address":
		return x.Address != ""
	case "eth.evm.v1.LogLite.topics":
		return len(x.Topics) != 0
	case "eth.evm.v1.LogLite.data":
		return len(x.Data) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.LogLite"))
		}
		panic(fmt.Errorf("message eth.evm.v1.LogLite does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LogLite) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "eth.evm.v1.LogLite.address":
		x.Address = ""
	case "eth.evm.v1.LogLite.topics":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_LogLite) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "eth.evm.v1.LogLite.address":
		value := x.Address
		return protoreflect.ValueOfString(value)
	case "eth.evm.v1.LogLite.topics":
		if len(x.Topics) == 0 {
			return protoreflect.ValueOfList(&_LogLite_2_list{})
		}
		listValue := &_LogLite_2_list{list: &x.Topics}
		return protoreflect.ValueOfList(listValue)
	case "eth.evm.v1.LogLite.data":
		value := x.Data
		return protoreflect.ValueOfBytes(value)
	default:
		...
		panic(fmt.Errorf("message eth.evm.v1.LogLite does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LogLite) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "eth.evm.v1.LogLite.address":
		x.Address = value.Interface().(string)
	case "eth.evm.v1.LogLite.topics":
		lv := value.List()
		clv := lv.(*_LogLite_2_list)
		x.Topics = *clv.list
	case "eth.evm.v1.LogLite.data":
		x.Data = value.Bytes()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LogLite) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.LogLite.topics":
		if x.Topics == nil {
			x.Topics = []string{}
		}
		value := &_LogLite_2_list{list: &x.Topics}
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.LogLite.address":
		panic(fmt.Errorf("field address of message eth.evm.v1.LogLite is not mutable"))
	case "eth.evm.v1.LogLite.data":
		panic(fmt.Errorf("field data of message eth.evm.v1.LogLite is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.LogLite"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_LogLite) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.LogLite.address":
		return protoreflect.ValueOfString("")
	case "eth.evm.v1.LogLite.topics":
		list := []string{}
		return protoreflect.ValueOfList(&_LogLite_2_list{list: &list})
	case "eth.evm.v1.LogLite.data":
		return protoreflect.ValueOfBytes(nil)
	default:
		if fd.IsExtension() {
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_LogLite) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in eth.evm.v1.LogLite", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_LogLite) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LogLite) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_LogLite) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_LogLite) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*LogLite)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: LogLite: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: LogLite: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *TracerConfig) slowProtoReflect() protoreflect.Message {
	mi := &file_eth_evm_v1_evm_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *TraceConfig) slowProtoReflect() protoreflect.Message {
	mi := &file_eth_evm_v1_evm_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
// addresses. For example, plugin name "oracle" can identify the Wasm adapter
...
func (*TracerConfig) Descriptor() ([]byte, []int) {
	return file_eth_evm_v1_evm_proto_rawDescGZIP(), []int{7}
}
...
func (*TraceConfig) Descriptor() ([]byte, []int) {
	return file_eth_evm_v1_evm_proto_rawDescGZIP(), []int{8}
}
...
var file_eth_evm_v1_evm_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x43, 0x6f, 0x69, 0x6e, 0x22, 0x9a, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x46, 0x65, 0x65, 0x12, 0x5f, 0x0a, 0x0f, 0x63, 0x61, 0x6e, 0x6f, 0x6e,
	0x69, 0x63, 0x61, 0x6c, 0x5f, 0x77, 0x6e, 0x69, 0x62, 0x69, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x22, 0x4f, 0x0a, 0x07, 0x4c, 0x6f, 0x67, 0x4c, 0x69,
	0x74, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06,
	0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f,
	0x70, 0x69, 0x63, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x61, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x65,
	...
	0x65, 0x4b, 0x65, 0x79, 0x73, 0x3a, 0x04, 0x88, 0xa0, 0x1f, 0x00, 0x22, 0x43, 0x0a, 0x0c, 0x54,
	0x72, 0x61, 0x63, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x33, 0x0a, 0x0d, 0x6f,
	0x6e, 0x6c, 0x79, 0x5f, 0x74, 0x6f, 0x70, 0x5f, 0x63, 0x61, 0x6c, 0x6c, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x42, 0x0f, 0xea, 0xde, 0x1f, 0x0b, 0x6f, 0x6e, 0x6c, 0x79, 0x54, 0x6f, 0x70, 0x43,
	0x61, 0x6c, 0x6c, 0x52, 0x0b, 0x6f, 0x6e, 0x6c, 0x79, 0x54, 0x6f, 0x70, 0x43, 0x61, 0x6c, 0x6c,
	0x22, 0xfa, 0x03, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x35, 0x0a, 0x0d, 0x65, 0x6e,
	...
	,
...
var file_eth_evm_v1_evm_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_eth_evm_v1_evm_proto_goTypes = []interface{}{
	(*FunToken)(nil),     // 0: eth.evm.v1.FunToken
	(*Params)(nil),       // 1: eth.evm.v1.Params
	(*WasmPlugin)(nil),   // 2: eth.evm.v1.WasmPlugin
	(*State)(nil),        // 3: eth.evm.v1.State
	(*Log)(nil),          // 4: eth.evm.v1.Log
	(*LogLite)(nil),      // 5: eth.evm.v1.LogLite
	(*AccessTuple)(nil),  // 6: eth.evm.v1.AccessTuple
	(*TracerConfig)(nil), // 7: eth.evm.v1.TracerConfig
	(*TraceConfig)(nil),  // 8: eth.evm.v1.TraceConfig
}
var file_eth_evm_v1_evm_proto_depIdxs = []int32{
	2, // 0: eth.evm.v1.Params.wasm_plugins:type_name -> eth.evm.v1.WasmPlugin
	7, // 1: eth.evm.v1.TraceConfig.tracer_config:type_name -> eth.evm.v1.TracerConfig
...
func file_eth_evm_v1_evm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eth_evm_v1_evm_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_evm_v1_evm_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
