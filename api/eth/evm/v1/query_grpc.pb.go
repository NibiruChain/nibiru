...
func (UnimplementedQueryServer) EthAccount(context.Context, *QueryEthAccountRequest) (*QueryEthAccountResponse, error) {
...
func (UnimplementedQueryServer) TraceCall(context.Context, *QueryTraceTxRequest) (*QueryTraceTxResponse, error) {
...
func (UnimplementedQueryServer) FunTokenMapping(context.Context, *QueryFunTokenMappingRequest) (*QueryFunTokenMappingResponse, error) {
