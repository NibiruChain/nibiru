...
const (
	Query_EthAccount_FullMethodName       = "/eth.evm.v1.Query/EthAccount"
	Query_ValidatorAccount_FullMethodName = "/eth.evm.v1.Query/ValidatorAccount"
	Query_Balance_FullMethodName          = "/eth.evm.v1.Query/Balance"
	Query_Storage_FullMethodName          = "/eth.evm.v1.Query/Storage"
	Query_Code_FullMethodName             = "/eth.evm.v1.Query/Code"
	Query_Params_FullMethodName           = "/eth.evm.v1.Query/Params"
	Query_EthCall_FullMethodName          = "/eth.evm.v1.Query/EthCall"
	Query_EstimateGas_FullMethodName      = "/eth.evm.v1.Query/EstimateGas"
	Query_TraceTx_FullMethodName          = "/eth.evm.v1.Query/TraceTx"
	Query_TraceBlock_FullMethodName       = "/eth.evm.v1.Query/TraceBlock"
	Query_TraceCall_FullMethodName        = "/eth.evm.v1.Query/TraceCall"
	Query_BaseFee_FullMethodName          = "/eth.evm.v1.Query/BaseFee"
	Query_FunTokenMapping_FullMethodName  = "/eth.evm.v1.Query/FunTokenMapping"
)
...
func (c *queryClient) EthAccount(ctx context.Context, in *QueryEthAccountRequest, opts ...grpc.CallOption) (*QueryEthAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_EthAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FunTokenMapping(ctx context.Context, in *QueryFunTokenMappingRequest, opts ...grpc.CallOption) (*QueryFunTokenMappingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_FunTokenMapping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EthAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_EthAccount_FullMethodName,
	}
...
func _Query_FunTokenMapping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_FunTokenMapping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
