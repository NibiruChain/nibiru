...
var _ protoreflect.List = (*_EventFunTokenCreated_5_list)(nil)

type _EventFunTokenCreated_5_list struct {
	list *[]*LogLite
}

func (x *_EventFunTokenCreated_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EventFunTokenCreated_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_EventFunTokenCreated_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	(*x.list)[i] = concreteValue
}

func (x *_EventFunTokenCreated_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	*x.list = append(*x.list, concreteValue)
}

func (x *_EventFunTokenCreated_5_list) AppendMutable() protoreflect.Value {
	v := new(LogLite)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventFunTokenCreated_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_EventFunTokenCreated_5_list) NewElement() protoreflect.Value {
	v := new(LogLite)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventFunTokenCreated_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EventFunTokenCreated_evm_logs               protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EventFunTokenCreated_evm_logs = md_EventFunTokenCreated.Fields().ByName("evm_logs")
}
...
func (x *fastReflection_EventFunTokenCreated) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.EvmLogs) != 0 {
		value := protoreflect.ValueOfList(&_EventFunTokenCreated_5_list{list: &x.EvmLogs})
		if !f(fd_EventFunTokenCreated_evm_logs, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventFunTokenCreated) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "eth.evm.v1.EventFunTokenCreated.evm_logs":
		return len(x.EvmLogs) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventFunTokenCreated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventFunTokenCreated.evm_logs":
		if len(x.EvmLogs) == 0 {
			return protoreflect.ValueOfList(&_EventFunTokenCreated_5_list{})
		}
		listValue := &_EventFunTokenCreated_5_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventFunTokenCreated"))
...
func (x *fastReflection_EventFunTokenCreated) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "eth.evm.v1.EventFunTokenCreated.evm_logs":
		lv := value.List()
		clv := lv.(*_EventFunTokenCreated_5_list)
		x.EvmLogs = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventFunTokenCreated"))
...
func (x *fastReflection_EventFunTokenCreated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventFunTokenCreated.evm_logs":
		...
		value := &_EventFunTokenCreated_5_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.EventFunTokenCreated.bank_denom":
...
func (x *fastReflection_EventFunTokenCreated) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventFunTokenCreated.evm_logs":
		list := []*LogLite{}
		return protoreflect.ValueOfList(&_EventFunTokenCreated_5_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventFunTokenCreated"))
		}
...
func (x *fastReflection_EventFunTokenCreated) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.EvmLogs) > 0 {
			for iNdEx := len(x.EvmLogs) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.EvmLogs[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EvmLogs", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.EvmLogs = append(x.EvmLogs, &LogLite{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.EvmLogs[len(x.EvmLogs)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var _ protoreflect.List = (*_EventConvertCoinToEvm_5_list)(nil)

type _EventConvertCoinToEvm_5_list struct {
	list *[]*LogLite
}

func (x *_EventConvertCoinToEvm_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EventConvertCoinToEvm_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_EventConvertCoinToEvm_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	(*x.list)[i] = concreteValue
}

func (x *_EventConvertCoinToEvm_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	*x.list = append(*x.list, concreteValue)
}

func (x *_EventConvertCoinToEvm_5_list) AppendMutable() protoreflect.Value {
	v := new(LogLite)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventConvertCoinToEvm_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_EventConvertCoinToEvm_5_list) NewElement() protoreflect.Value {
	v := new(LogLite)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventConvertCoinToEvm_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EventConvertCoinToEvm_evm_logs               protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EventConvertCoinToEvm_evm_logs = md_EventConvertCoinToEvm.Fields().ByName("evm_logs")
}
...
func (x *fastReflection_EventConvertCoinToEvm) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.EvmLogs) != 0 {
		value := protoreflect.ValueOfList(&_EventConvertCoinToEvm_5_list{list: &x.EvmLogs})
		if !f(fd_EventConvertCoinToEvm_evm_logs, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventConvertCoinToEvm) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "eth.evm.v1.EventConvertCoinToEvm.evm_logs":
		return len(x.EvmLogs) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventConvertCoinToEvm) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertCoinToEvm.evm_logs":
		if len(x.EvmLogs) == 0 {
			return protoreflect.ValueOfList(&_EventConvertCoinToEvm_5_list{})
		}
		listValue := &_EventConvertCoinToEvm_5_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertCoinToEvm"))
...
func (x *fastReflection_EventConvertCoinToEvm) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "eth.evm.v1.EventConvertCoinToEvm.evm_logs":
		lv := value.List()
		clv := lv.(*_EventConvertCoinToEvm_5_list)
		x.EvmLogs = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertCoinToEvm"))
...
func (x *fastReflection_EventConvertCoinToEvm) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertCoinToEvm.evm_logs":
		...
		value := &_EventConvertCoinToEvm_5_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.EventConvertCoinToEvm.sender":
...
func (x *fastReflection_EventConvertCoinToEvm) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertCoinToEvm.evm_logs":
		list := []*LogLite{}
		return protoreflect.ValueOfList(&_EventConvertCoinToEvm_5_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertCoinToEvm"))
		}
...
var _ protoreflect.List = (*_EventConvertEvmToCoin_7_list)(nil)

type _EventConvertEvmToCoin_7_list struct {
	list *[]*LogLite
}

func (x *_EventConvertEvmToCoin_7_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EventConvertEvmToCoin_7_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_EventConvertEvmToCoin_7_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	(*x.list)[i] = concreteValue
}

func (x *_EventConvertEvmToCoin_7_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*LogLite)
	*x.list = append(*x.list, concreteValue)
}

func (x *_EventConvertEvmToCoin_7_list) AppendMutable() protoreflect.Value {
	v := new(LogLite)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventConvertEvmToCoin_7_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_EventConvertEvmToCoin_7_list) NewElement() protoreflect.Value {
	v := new(LogLite)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventConvertEvmToCoin_7_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EventConvertEvmToCoin_evm_logs               protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EventConvertEvmToCoin_evm_logs = md_EventConvertEvmToCoin.Fields().ByName("evm_logs")
}
...
func (x *fastReflection_EventConvertEvmToCoin) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.EvmLogs) != 0 {
		value := protoreflect.ValueOfList(&_EventConvertEvmToCoin_7_list{list: &x.EvmLogs})
		if !f(fd_EventConvertEvmToCoin_evm_logs, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventConvertEvmToCoin) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "eth.evm.v1.EventConvertEvmToCoin.evm_logs":
		return len(x.EvmLogs) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventConvertEvmToCoin) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertEvmToCoin.evm_logs":
		if len(x.EvmLogs) == 0 {
			return protoreflect.ValueOfList(&_EventConvertEvmToCoin_7_list{})
		}
		listValue := &_EventConvertEvmToCoin_7_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertEvmToCoin"))
...
func (x *fastReflection_EventConvertEvmToCoin) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "eth.evm.v1.EventConvertEvmToCoin.evm_logs":
		lv := value.List()
		clv := lv.(*_EventConvertEvmToCoin_7_list)
		x.EvmLogs = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertEvmToCoin"))
...
func (x *fastReflection_EventConvertEvmToCoin) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertEvmToCoin.evm_logs":
		...
		value := &_EventConvertEvmToCoin_7_list{list: &x.EvmLogs}
		return protoreflect.ValueOfList(value)
	case "eth.evm.v1.EventConvertEvmToCoin.sender":
...
func (x *fastReflection_EventConvertEvmToCoin) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "eth.evm.v1.EventConvertEvmToCoin.evm_logs":
		list := []*LogLite{}
		return protoreflect.ValueOfList(&_EventConvertEvmToCoin_7_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventConvertEvmToCoin"))
		}
...
var (
	md_EventWeiBlockDelta                     protoreflect.MessageDescriptor
	fd_EventWeiBlockDelta_net_wei_block_delta protoreflect.FieldDescriptor
	fd_EventWeiBlockDelta_wei_block_delta     protoreflect.FieldDescriptor
	fd_EventWeiBlockDelta_block_number        protoreflect.FieldDescriptor
)

func init() {
	file_eth_evm_v1_events_proto_init()
	md_EventWeiBlockDelta = File_eth_evm_v1_events_proto.Messages().ByName("EventWeiBlockDelta")
	fd_EventWeiBlockDelta_net_wei_block_delta = md_EventWeiBlockDelta.Fields().ByName("net_wei_block_delta")
	fd_EventWeiBlockDelta_wei_block_delta = md_EventWeiBlockDelta.Fields().ByName("wei_block_delta")
	fd_EventWeiBlockDelta_block_number = md_EventWeiBlockDelta.Fields().ByName("block_number")
}

var _ protoreflect.Message = (*fastReflection_EventWeiBlockDelta)(nil)

type fastReflection_EventWeiBlockDelta EventWeiBlockDelta

func (x *EventWeiBlockDelta) ProtoReflect() protoreflect.Message {
	return (*fastReflection_EventWeiBlockDelta)(x)
}

func (x *EventWeiBlockDelta) slowProtoReflect() protoreflect.Message {
	mi := &file_eth_evm_v1_events_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_EventWeiBlockDelta_messageType fastReflection_EventWeiBlockDelta_messageType
var _ protoreflect.MessageType = fastReflection_EventWeiBlockDelta_messageType{}

type fastReflection_EventWeiBlockDelta_messageType struct{}

func (x fastReflection_EventWeiBlockDelta_messageType) Zero() protoreflect.Message {
	return (*fastReflection_EventWeiBlockDelta)(nil)
}
func (x fastReflection_EventWeiBlockDelta_messageType) New() protoreflect.Message {
	return new(fastReflection_EventWeiBlockDelta)
}
func (x fastReflection_EventWeiBlockDelta_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_EventWeiBlockDelta
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_EventWeiBlockDelta) Descriptor() protoreflect.MessageDescriptor {
	return md_EventWeiBlockDelta
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_EventWeiBlockDelta) Type() protoreflect.MessageType {
	return _fastReflection_EventWeiBlockDelta_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_EventWeiBlockDelta) New() protoreflect.Message {
	return new(fastReflection_EventWeiBlockDelta)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_EventWeiBlockDelta) Interface() protoreflect.ProtoMessage {
	return (*EventWeiBlockDelta)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_EventWeiBlockDelta) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.NetWeiBlockDelta != "" {
		value := protoreflect.ValueOfString(x.NetWeiBlockDelta)
		if !f(fd_EventWeiBlockDelta_net_wei_block_delta, value) {
			return
		}
	}
	if x.WeiBlockDelta != "" {
		value := protoreflect.ValueOfString(x.WeiBlockDelta)
		if !f(fd_EventWeiBlockDelta_wei_block_delta, value) {
			return
		}
	}
	if x.BlockNumber != uint64(0) {
		value := protoreflect.ValueOfUint64(x.BlockNumber)
		if !f(fd_EventWeiBlockDelta_block_number, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_EventWeiBlockDelta) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		return x.NetWeiBlockDelta != ""
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
		return x.WeiBlockDelta != ""
	case "eth.evm.v1.EventWeiBlockDelta.block_number":
		return x.BlockNumber != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventWeiBlockDelta"))
		}
		panic(fmt.Errorf("message eth.evm.v1.EventWeiBlockDelta does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventWeiBlockDelta) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		x.NetWeiBlockDelta = ""
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_EventWeiBlockDelta) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		value := x.NetWeiBlockDelta
		return protoreflect.ValueOfString(value)
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
		value := x.WeiBlockDelta
		return protoreflect.ValueOfString(value)
	case "eth.evm.v1.EventWeiBlockDelta.block_number":
		value := x.BlockNumber
	...
	default:
		...
		panic(fmt.Errorf("message eth.evm.v1.EventWeiBlockDelta does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventWeiBlockDelta) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		x.NetWeiBlockDelta = value.Interface().(string)
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
		x.WeiBlockDelta = value.Interface().(string)
	case "eth.evm.v1.EventWeiBlockDelta.block_number":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventWeiBlockDelta) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		panic(fmt.Errorf("field net_wei_block_delta of message eth.evm.v1.EventWeiBlockDelta is not mutable"))
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
		panic(fmt.Errorf("field wei_block_delta of message eth.evm.v1.EventWeiBlockDelta is not mutable"))
	case "eth.evm.v1.EventWeiBlockDelta.block_number":
		panic(fmt.Errorf("field block_number of message eth.evm.v1.EventWeiBlockDelta is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: eth.evm.v1.EventWeiBlockDelta"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_EventWeiBlockDelta) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "eth.evm.v1.EventWeiBlockDelta.net_wei_block_delta":
		return protoreflect.ValueOfString("")
	case "eth.evm.v1.EventWeiBlockDelta.wei_block_delta":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_EventWeiBlockDelta) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in eth.evm.v1.EventWeiBlockDelta", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_EventWeiBlockDelta) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventWeiBlockDelta) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_EventWeiBlockDelta) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_EventWeiBlockDelta) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*EventWeiBlockDelta)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		var l int
		_ = l
		l = len(x.NetWeiBlockDelta)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.WeiBlockDelta)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.BlockNumber != 0 {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.WeiBlockDelta) > 0 {
			i -= len(x.WeiBlockDelta)
			copy(dAtA[i:], x.WeiBlockDelta)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.WeiBlockDelta)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.NetWeiBlockDelta) > 0 {
			i -= len(x.NetWeiBlockDelta)
			copy(dAtA[i:], x.NetWeiBlockDelta)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.NetWeiBlockDelta)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EventWeiBlockDelta: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EventWeiBlockDelta: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field NetWeiBlockDelta", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.NetWeiBlockDelta = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field WeiBlockDelta", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.WeiBlockDelta = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 0 {
...
func (x *EventFunTokenCreated) GetEvmLogs() []*LogLite {
	if x != nil {
		return x.EvmLogs
	}
	return nil
...
func (*EventWeiBlockDelta) Descriptor() ([]byte, []int) {
	return file_eth_evm_v1_events_proto_rawDescGZIP(), []int{9}
}
...
var file_eth_evm_v1_events_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x6f, 0x6d, 0x22, 0xe6, 0x01, 0x0a, 0x14, 0x45, 0x76, 0x65,
	...
	,
	...
	,
	...
	0x22, 0x54, 0x0a, 0x15, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63,
	0x74, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x6e,
	0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61,
	0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x22, 0x54, 0x0a, 0x15, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x64, 0x12,
	...
	,
	...
	0x65, 0x73, 0x73, 0x12, 0x50, 0x0a, 0x09, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x63, 0x6f, 0x69, 0x6e,
	...
	,
	...
	0x65, 0x72, 0x42, 0x8a, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x65,
	0x76, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f,
...
var file_eth_evm_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_eth_evm_v1_events_proto_goTypes = []interface{}{
	...
	(*EventWeiBlockDelta)(nil),    // 9: eth.evm.v1.EventWeiBlockDelta
	(*Log)(nil),                   // 10: eth.evm.v1.Log
	(*LogLite)(nil),               // 11: eth.evm.v1.LogLite
	(*v1beta1.Coin)(nil),          // 12: cosmos.base.v1beta1.Coin
}
var file_eth_evm_v1_events_proto_depIdxs = []int32{
	10, // 0: eth.evm.v1.EventTxLog.logs:type_name -> eth.evm.v1.Log
	11, // 1: eth.evm.v1.EventFunTokenCreated.evm_logs:type_name -> eth.evm.v1.LogLite
	12, // 2: eth.evm.v1.EventConvertCoinToEvm.bank_coin:type_name -> cosmos.base.v1beta1.Coin
	11, // 3: eth.evm.v1.EventConvertCoinToEvm.evm_logs:type_name -> eth.evm.v1.LogLite
	12, // 4: eth.evm.v1.EventConvertEvmToCoin.bank_coin:type_name -> cosmos.base.v1beta1.Coin
	11, // 5: eth.evm.v1.EventConvertEvmToCoin.evm_logs:type_name -> eth.evm.v1.LogLite
...
func file_eth_evm_v1_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eth_evm_v1_events_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventWeiBlockDelta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
