...
func init() {
	...
	md_EpochInfo = File_nibiru_epochs_v1_state_proto.Messages().ByName("EpochInfo")
...
func (x *EpochInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_nibiru_epochs_v1_state_proto_msgTypes[0]
...
func (x *fastReflection_EpochInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nibiru.epochs.v1.EpochInfo.identifier":
		return x.Identifier != ""
	case "nibiru.epochs.v1.EpochInfo.start_time":
		return x.StartTime != nil
	case "nibiru.epochs.v1.EpochInfo.duration":
		return x.Duration != nil
	case "nibiru.epochs.v1.EpochInfo.current_epoch":
		return x.CurrentEpoch != uint64(0)
	case "nibiru.epochs.v1.EpochInfo.current_epoch_start_time":
		return x.CurrentEpochStartTime != nil
	case "nibiru.epochs.v1.EpochInfo.epoch_counting_started":
		return x.EpochCountingStarted != false
	case "nibiru.epochs.v1.EpochInfo.current_epoch_start_height":
		return x.CurrentEpochStartHeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.epochs.v1.EpochInfo"))
		}
		panic(fmt.Errorf("message nibiru.epochs.v1.EpochInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message nibiru.epochs.v1.EpochInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nibiru.epochs.v1.EpochInfo.identifier":
		panic(fmt.Errorf("field identifier of message nibiru.epochs.v1.EpochInfo is not mutable"))
	case "nibiru.epochs.v1.EpochInfo.current_epoch":
		panic(fmt.Errorf("field current_epoch of message nibiru.epochs.v1.EpochInfo is not mutable"))
	case "nibiru.epochs.v1.EpochInfo.epoch_counting_started":
		panic(fmt.Errorf("field epoch_counting_started of message nibiru.epochs.v1.EpochInfo is not mutable"))
	case "nibiru.epochs.v1.EpochInfo.current_epoch_start_height":
		panic(fmt.Errorf("field current_epoch_start_height of message nibiru.epochs.v1.EpochInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.epochs.v1.EpochInfo"))
		}
...
func (x *fastReflection_EpochInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nibiru.epochs.v1.EpochInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return file_nibiru_epochs_v1_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *EpochInfo) GetCurrentEpoch() uint64 {
	if x != nil {
...
var File_nibiru_epochs_v1_state_proto protoreflect.FileDescriptor

var file_nibiru_epochs_v1_state_proto_rawDesc = []byte{
	...
	,
}

var (
	file_nibiru_epochs_v1_state_proto_rawDescOnce sync.Once
	file_nibiru_epochs_v1_state_proto_rawDescData = file_nibiru_epochs_v1_state_proto_rawDesc
)

func file_nibiru_epochs_v1_state_proto_rawDescGZIP() []byte {
	file_nibiru_epochs_v1_state_proto_rawDescOnce.Do(func() {
		file_nibiru_epochs_v1_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_nibiru_epochs_v1_state_proto_rawDescData)
	})
	return file_nibiru_epochs_v1_state_proto_rawDescData
}

var file_nibiru_epochs_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_nibiru_epochs_v1_state_proto_goTypes = []interface{}{
	(*EpochInfo)(nil),             // 0: nibiru.epochs.v1.EpochInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_nibiru_epochs_v1_state_proto_depIdxs = []int32{
	1, // 0: nibiru.epochs.v1.EpochInfo.start_time:type_name -> google.protobuf.Timestamp
	2, // 1: nibiru.epochs.v1.EpochInfo.duration:type_name -> google.protobuf.Duration
	1, // 2: nibiru.epochs.v1.EpochInfo.current_epoch_start_time:type_name -> google.protobuf.Timestamp
...
func init() { file_nibiru_epochs_v1_state_proto_init() }
func file_nibiru_epochs_v1_state_proto_init() {
	if File_nibiru_epochs_v1_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_nibiru_epochs_v1_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nibiru_epochs_v1_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_nibiru_epochs_v1_state_proto_goTypes,
		DependencyIndexes: file_nibiru_epochs_v1_state_proto_depIdxs,
		MessageInfos:      file_nibiru_epochs_v1_state_proto_msgTypes,
	}.Build()
	File_nibiru_epochs_v1_state_proto = out.File
	file_nibiru_epochs_v1_state_proto_rawDesc = nil
	file_nibiru_epochs_v1_state_proto_goTypes = nil
	file_nibiru_epochs_v1_state_proto_depIdxs = nil
}
