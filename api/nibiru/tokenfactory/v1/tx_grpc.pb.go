...
const (
	Msg_CreateDenom_FullMethodName        = "/nibiru.tokenfactory.v1.Msg/CreateDenom"
	Msg_ChangeAdmin_FullMethodName        = "/nibiru.tokenfactory.v1.Msg/ChangeAdmin"
	Msg_UpdateModuleParams_FullMethodName = "/nibiru.tokenfactory.v1.Msg/UpdateModuleParams"
	Msg_Mint_FullMethodName               = "/nibiru.tokenfactory.v1.Msg/Mint"
	Msg_Burn_FullMethodName               = "/nibiru.tokenfactory.v1.Msg/Burn"
	Msg_SetDenomMetadata_FullMethodName   = "/nibiru.tokenfactory.v1.Msg/SetDenomMetadata"
	Msg_BurnNative_FullMethodName         = "/nibiru.tokenfactory.v1.Msg/BurnNative"
)
...
func (c *msgClient) UpdateModuleParams(ctx context.Context, in *MsgUpdateModuleParams, opts ...grpc.CallOption) (*MsgUpdateModuleParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateModuleParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BurnNative(ctx context.Context, in *MsgBurnNative, opts ...grpc.CallOption) (*MsgBurnNativeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_BurnNative_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateModuleParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateModuleParams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BurnNative_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_BurnNative_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
