...
const (
	Query_FeeShares_FullMethodName             = "/nibiru.devgas.v1.Query/FeeShares"
	Query_FeeShare_FullMethodName              = "/nibiru.devgas.v1.Query/FeeShare"
	Query_Params_FullMethodName                = "/nibiru.devgas.v1.Query/Params"
	Query_FeeSharesByWithdrawer_FullMethodName = "/nibiru.devgas.v1.Query/FeeSharesByWithdrawer"
)
...
func (c *queryClient) FeeSharesByWithdrawer(ctx context.Context, in *QueryFeeSharesByWithdrawerRequest, opts ...grpc.CallOption) (*QueryFeeSharesByWithdrawerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_FeeSharesByWithdrawer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FeeSharesByWithdrawer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_FeeSharesByWithdrawer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
