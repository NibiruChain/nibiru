...
var (
	md_MsgEditZeroGasActors        protoreflect.MessageDescriptor
	fd_MsgEditZeroGasActors_actors protoreflect.FieldDescriptor
	fd_MsgEditZeroGasActors_sender protoreflect.FieldDescriptor
)

func init() {
	file_nibiru_sudo_v1_tx_proto_init()
	md_MsgEditZeroGasActors = File_nibiru_sudo_v1_tx_proto.Messages().ByName("MsgEditZeroGasActors")
	fd_MsgEditZeroGasActors_actors = md_MsgEditZeroGasActors.Fields().ByName("actors")
	fd_MsgEditZeroGasActors_sender = md_MsgEditZeroGasActors.Fields().ByName("sender")
}

var _ protoreflect.Message = (*fastReflection_MsgEditZeroGasActors)(nil)

type fastReflection_MsgEditZeroGasActors MsgEditZeroGasActors

func (x *MsgEditZeroGasActors) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgEditZeroGasActors)(x)
}

func (x *MsgEditZeroGasActors) slowProtoReflect() protoreflect.Message {
	mi := &file_nibiru_sudo_v1_tx_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgEditZeroGasActors_messageType fastReflection_MsgEditZeroGasActors_messageType
var _ protoreflect.MessageType = fastReflection_MsgEditZeroGasActors_messageType{}

type fastReflection_MsgEditZeroGasActors_messageType struct{}

func (x fastReflection_MsgEditZeroGasActors_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgEditZeroGasActors)(nil)
}
func (x fastReflection_MsgEditZeroGasActors_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgEditZeroGasActors)
}
func (x fastReflection_MsgEditZeroGasActors_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEditZeroGasActors
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgEditZeroGasActors) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEditZeroGasActors
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgEditZeroGasActors) Type() protoreflect.MessageType {
	return _fastReflection_MsgEditZeroGasActors_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgEditZeroGasActors) New() protoreflect.Message {
	return new(fastReflection_MsgEditZeroGasActors)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgEditZeroGasActors) Interface() protoreflect.ProtoMessage {
	return (*MsgEditZeroGasActors)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgEditZeroGasActors) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Actors != nil {
		value := protoreflect.ValueOfMessage(x.Actors.ProtoReflect())
		if !f(fd_MsgEditZeroGasActors_actors, value) {
			return
		}
	}
	if x.Sender != "" {
		value := protoreflect.ValueOfString(x.Sender)
		if !f(fd_MsgEditZeroGasActors_sender, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgEditZeroGasActors) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
		return x.Actors != nil
	case "nibiru.sudo.v1.MsgEditZeroGasActors.sender":
		return x.Sender != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActors"))
		}
		panic(fmt.Errorf("message nibiru.sudo.v1.MsgEditZeroGasActors does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActors) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
		x.Actors = nil
	case "nibiru.sudo.v1.MsgEditZeroGasActors.sender":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgEditZeroGasActors) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
		value := x.Actors
	...
	default:
		...
		panic(fmt.Errorf("message nibiru.sudo.v1.MsgEditZeroGasActors does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActors) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActors) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
		if x.Actors == nil {
	...
	case "nibiru.sudo.v1.MsgEditZeroGasActors.sender":
		panic(fmt.Errorf("field sender of message nibiru.sudo.v1.MsgEditZeroGasActors is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActors"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgEditZeroGasActors) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nibiru.sudo.v1.MsgEditZeroGasActors.actors":
		m := new(ZeroGasActors)
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgEditZeroGasActors) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nibiru.sudo.v1.MsgEditZeroGasActors", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgEditZeroGasActors) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActors) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgEditZeroGasActors) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgEditZeroGasActors) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgEditZeroGasActors)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEditZeroGasActors: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEditZeroGasActors: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgEditZeroGasActorsResponse protoreflect.MessageDescriptor
)

func init() {
	file_nibiru_sudo_v1_tx_proto_init()
	md_MsgEditZeroGasActorsResponse = File_nibiru_sudo_v1_tx_proto.Messages().ByName("MsgEditZeroGasActorsResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgEditZeroGasActorsResponse)(nil)

type fastReflection_MsgEditZeroGasActorsResponse MsgEditZeroGasActorsResponse

func (x *MsgEditZeroGasActorsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgEditZeroGasActorsResponse)(x)
}

func (x *MsgEditZeroGasActorsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_nibiru_sudo_v1_tx_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgEditZeroGasActorsResponse_messageType fastReflection_MsgEditZeroGasActorsResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgEditZeroGasActorsResponse_messageType{}

type fastReflection_MsgEditZeroGasActorsResponse_messageType struct{}

func (x fastReflection_MsgEditZeroGasActorsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgEditZeroGasActorsResponse)(nil)
}
func (x fastReflection_MsgEditZeroGasActorsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgEditZeroGasActorsResponse)
}
func (x fastReflection_MsgEditZeroGasActorsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEditZeroGasActorsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEditZeroGasActorsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgEditZeroGasActorsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgEditZeroGasActorsResponse) New() protoreflect.Message {
	return new(fastReflection_MsgEditZeroGasActorsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgEditZeroGasActorsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
		}
		panic(fmt.Errorf("message nibiru.sudo.v1.MsgEditZeroGasActorsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
		}
		panic(fmt.Errorf("message nibiru.sudo.v1.MsgEditZeroGasActorsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActorsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgEditZeroGasActorsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nibiru.sudo.v1.MsgEditZeroGasActorsResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgEditZeroGasActorsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nibiru.sudo.v1.MsgEditZeroGasActorsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgEditZeroGasActorsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEditZeroGasActorsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgEditZeroGasActorsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgEditZeroGasActorsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgEditZeroGasActorsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEditZeroGasActorsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEditZeroGasActorsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
func (x *MsgEditZeroGasActors) Reset() {
	*x = MsgEditZeroGasActors{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nibiru_sudo_v1_tx_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgEditZeroGasActors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgEditZeroGasActors) ProtoMessage() {}

// Deprecated: Use MsgEditZeroGasActors.ProtoReflect.Descriptor instead.
func (*MsgEditZeroGasActors) Descriptor() ([]byte, []int) {
	return file_nibiru_sudo_v1_tx_proto_rawDescGZIP(), []int{4}
}

func (x *MsgEditZeroGasActors) GetActors() *ZeroGasActors {
	if x != nil {
		return x.Actors
	}
	return nil
...
func (x *MsgEditZeroGasActors) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
func (x *MsgEditZeroGasActorsResponse) Reset() {
	*x = MsgEditZeroGasActorsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nibiru_sudo_v1_tx_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgEditZeroGasActorsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgEditZeroGasActorsResponse) ProtoMessage() {}

// Deprecated: Use MsgEditZeroGasActorsResponse.ProtoReflect.Descriptor instead.
func (*MsgEditZeroGasActorsResponse) Descriptor() ([]byte, []int) {
	return file_nibiru_sudo_v1_tx_proto_rawDescGZIP(), []int{5}
}
...
var file_nibiru_sudo_v1_tx_proto_rawDesc = []byte{
	...
	,
...
var file_nibiru_sudo_v1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_nibiru_sudo_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgEditZeroGasActors)(nil),         // 4: nibiru.sudo.v1.MsgEditZeroGasActors
	(*MsgEditZeroGasActorsResponse)(nil), // 5: nibiru.sudo.v1.MsgEditZeroGasActorsResponse
	(*ZeroGasActors)(nil),                // 6: nibiru.sudo.v1.ZeroGasActors
}
var file_nibiru_sudo_v1_tx_proto_depIdxs = []int32{
	6, // 0: nibiru.sudo.v1.MsgEditZeroGasActors.actors:type_name -> nibiru.sudo.v1.ZeroGasActors
	0, // 1: nibiru.sudo.v1.Msg.EditSudoers:input_type -> nibiru.sudo.v1.MsgEditSudoers
	2, // 2: nibiru.sudo.v1.Msg.ChangeRoot:input_type -> nibiru.sudo.v1.MsgChangeRoot
	4, // 3: nibiru.sudo.v1.Msg.EditZeroGasActors:input_type -> nibiru.sudo.v1.MsgEditZeroGasActors
	1, // 4: nibiru.sudo.v1.Msg.EditSudoers:output_type -> nibiru.sudo.v1.MsgEditSudoersResponse
	3, // 5: nibiru.sudo.v1.Msg.ChangeRoot:output_type -> nibiru.sudo.v1.MsgChangeRootResponse
	5, // 6: nibiru.sudo.v1.Msg.EditZeroGasActors:output_type -> nibiru.sudo.v1.MsgEditZeroGasActorsResponse
...
func file_nibiru_sudo_v1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nibiru_sudo_v1_tx_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgEditZeroGasActors); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nibiru_sudo_v1_tx_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgEditZeroGasActorsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
