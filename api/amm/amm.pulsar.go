...
var (
	...
	fd_Pool_QuoteAssetReserve protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Pool_QuoteAssetReserve = md_Pool.Fields().ByName("QuoteAssetReserve")
}
...
func (x *fastReflection_Pool) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.QuoteAssetReserve != "" {
		...
		if !f(fd_Pool_QuoteAssetReserve, value) {
			return
		}
	}
}
...
func (x *fastReflection_Pool) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "matrix.amm.v1.Pool.Pair":
		return x.Pair != ""
	case "matrix.amm.v1.Pool.QuoteAssetReserve":
...
func (x *fastReflection_Pool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "matrix.amm.v1.Pool.QuoteAssetReserve":
		panic(fmt.Errorf("field QuoteAssetReserve of message matrix.amm.v1.Pool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: matrix.amm.v1.Pool"))
		}
...
type Pool struct {
	...
	QuoteAssetReserve string `protobuf:"bytes,2,opt,name=QuoteAssetReserve,proto3" json:"QuoteAssetReserve,omitempty"`
}
...
var file_amm_amm_proto_rawDesc = []byte{
	...
	0x0d, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x78, 0x2e, 0x61, 0x6d, 0x6d, 0x2e, 0x76, 0x31, 0x22, 0x48,
	0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61, 0x69, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x50, 0x61, 0x69, 0x72, 0x12, 0x2c, 0x0a, 0x11, 0x51, 0x75,
	0x6f, 0x74, 0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x41, 0x73, 0x73, 0x65,
	0x74, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x2a, 0x3f, 0x0a, 0x09, 0x44, 0x69, 0x72, 0x65,
