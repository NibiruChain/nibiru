...
Reference: 
- [Nibiru Networks and RPCs](../networks/index.md)
...
1. Provider Setup: Connects to the Nibiru Testnet via the [RPC endpoint](../networks/index.md) (<https://evm-rpc.testnet-2.nibiru.fi/>) to establish communication with the Ethereum-compatible network.
...
Reference: [Nibiru Networks and RPCs](../networks/index.md)
