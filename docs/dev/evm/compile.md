---
order: 2
title: "Nibiru EVM | Compiling EVM Smart Contracts"
description: >-
...
Before diving into compilation, it's helpful to understand the basics of smart contracts and the EVM. You can refer to the [Ethereum Smart Contracts Introduction](https://ethereum.org/en/developers/docs/smart-contracts/) and the [Nibiru's Ethereum Virtual Machine documentation](../evm/index.md) for a foundational understanding.
