...
description: >-
  ...
  token. These emissions go to stakers, the Nibiru Foundation
  treasury, and the community reserve.
---
...
You can query these parameters on mainnet using the [Nibiru CLI](../../../dev/cli/index.md).
```bash
# Mainnet CLI Config
