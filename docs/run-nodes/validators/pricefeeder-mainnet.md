...
order: 4
description: >-
  Instructions for validators to set up a Mainnet pricefeeder.
---
...
| GRPC_ENDPOINT        | the endpoint to fetch query params send txs                                                                   | **localhost:9090** if running locally **grpc.nibiru.fi:443** if running remotely                                                                   |
