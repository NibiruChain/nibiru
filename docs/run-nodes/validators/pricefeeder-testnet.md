---
order: 3
description: Instructions for validators to set up a Testnet pricefeeder.
---
...
| GRPC_ENDPOINT        | the endpoint to fetch query params send txs                                                                   | **localhost:9090** if running locally **lcd.testnet-2.nibiru.fi:443** if running remotely                                                                   |
| WEBSOCKET_ENDPOINT   | the endpoint to fetch streaming updates                                                                       | **ws://localhost:26657/websocket** if running locally **wss://lcd.testnet-2.nibiru.fi/websocket** if running remotely                                        |
