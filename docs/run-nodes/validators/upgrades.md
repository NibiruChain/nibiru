...
order: 5
description: >-
  Every now and then, the Nibiru blockchain will undergo a chain upgrade, which means validators will have to swap the currently running binary for the new binary version at a given block height.
---
