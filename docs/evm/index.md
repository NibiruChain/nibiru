---
order: 0
title: "Nibiru EVM | Built Different"
description: >-
...
| --- | --- |
| [Why Nibiru EVM?](./#why-nibiru-evm) | A brief primer on the Ethereum Virtual Machine (EVM) portion of Nibiru's Execution Engine. |
...
| [News on Nibiru EVM](./news/index.md) | Latest articles and press releases on Nibiru EVM |
...
different [consensus engine](../concepts/arch/index.md#nibirubft-consensus-engine) yet leverages an
...
of the broader [Nibiru Execution Engine](../concepts/arch/index.md). 
...
1. [News on Nibiru EVM](./news/index.md)
