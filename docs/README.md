...
const boxesMain = [
  ...
  { id: 3, title: "Learn Core Concepts", href: "/docs/concepts/",
    text: `Build an understanding of the core concepts behind how Nibiru works. Topics explored in this section provide a solid foundation on both the Nibiru blockchain and Web3 in general.` },
