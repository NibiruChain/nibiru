...
func (t *EVMTrader) OpenTradeFromConfig(ctx context.Context) error {
	...
	erc20Addr := common.HexToAddress(t.collateralERC20())
...
// collateralERC20 returns the EVM ERC20 address for trade collateral.
func (t *EVMTrader) collateralERC20() string {
	if t.addrs.TokenUSDCErc20 != "" {
		return t.addrs.TokenUSDCErc20
	}
	return t.addrs.TokenStNIBIERC20
}
