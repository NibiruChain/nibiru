...
use crate::calls::{
    call_execute, call_instantiate, call_migrate, call_query, call_reply,
    call_sudo,
};
#[cfg(feature = "stargate")]
use crate::calls::{
    call_ibc_channel_close, call_ibc_channel_connect, call_ibc_channel_open,
    call_ibc_packet_ack, call_ibc_packet_receive, call_ibc_packet_timeout,
};
