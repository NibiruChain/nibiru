...
func NewSimApp(
	...
	*/
	...
	app.mm.SetOrderBeginBlockers(
		...
		paramstypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, ibcmock.ModuleName, group.ModuleName, consensusparamtypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(
		...
		upgradetypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, ibcmock.ModuleName, group.ModuleName, consensusparamtypes.ModuleName,
	)
