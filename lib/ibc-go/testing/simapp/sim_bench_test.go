...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/NibiruChain/nibiru/v2/lib/ibc-go/testing/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
