...
func GetClientID(clientStore sdk.KVStore) (string, error) {
...
func NewMigrateProposalWrappedStore(subjectStore, substituteStore sdk.KVStore) migrateClientWrappedStore {
...
func (ws migrateClientWrappedStore) GetStore(key []byte) (sdk.KVStore, bool) {
