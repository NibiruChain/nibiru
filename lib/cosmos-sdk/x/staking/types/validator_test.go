...
func TestShareTokens(t *testing.T) {
	validator := mkValidator(100, sdkmath.LegacyNewDec(100))
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(50), validator.TokensFromShares(sdkmath.LegacyNewDec(50))))

	validator.Tokens = sdk.NewInt(50)
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(25), validator.TokensFromShares(sdkmath.LegacyNewDec(50))))
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(5), validator.TokensFromShares(sdkmath.LegacyNewDec(10))))
}
...
func TestAddTokensValidatorBonded(t *testing.T) {
	...
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(10), delShares))
	assert.True(sdkmath.IntEq(t, sdk.NewInt(10), validator.BondedTokens()))
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(10), validator.DelegatorShares))
}
...
func TestAddTokensValidatorUnbonding(t *testing.T) {
	...
	assert.True(sdkmath.IntEq(t, sdk.NewInt(10), validator.Tokens))
	assert.True(sdk.DecEq(t, sdkmath.LegacyNewDec(10), validator.DelegatorShares))
}
...
func TestRemoveDelShares(t *testing.T) {
	...
	valB, coinsB := valA.RemoveDelShares(sdkmath.LegacyNewDec(10))
	...
	validator := mkValidator(5102, sdkmath.LegacyNewDec(115))
	_, tokens := validator.RemoveDelShares(sdkmath.LegacyNewDec(29))

	require.True(sdkmath.IntEq(t, sdk.NewInt(1286), tokens))
}
...
func TestAddTokensFromDel(t *testing.T) {
	...
	require.True(sdk.DecEq(t, sdkmath.LegacyNewDec(6), shares))
	require.True(sdk.DecEq(t, sdkmath.LegacyNewDec(6), validator.DelegatorShares))
	require.True(sdkmath.IntEq(t, sdk.NewInt(6), validator.Tokens))

	validator, shares = validator.AddTokensFromDel(sdk.NewInt(3))
	require.True(sdk.DecEq(t, sdkmath.LegacyNewDec(3), shares))
	require.True(sdk.DecEq(t, sdkmath.LegacyNewDec(9), validator.DelegatorShares))
	require.True(sdkmath.IntEq(t, sdk.NewInt(9), validator.Tokens))
}
...
func TestPossibleOverflow(t *testing.T) {
	delShares := sdkmath.LegacyNewDec(391432570689183511).Quo(sdkmath.LegacyNewDec(40113011844664))
...
func TestValidatorSetInitialCommission(t *testing.T) {
	...
	testCases := []struct {
		...
		{val, types.NewCommission(sdkmath.LegacyZeroDec(), sdkmath.LegacyZeroDec(), sdkmath.LegacyZeroDec()), false},
		{val, types.NewCommission(sdkmath.LegacyZeroDec(), sdk.NewDecWithPrec(-1, 1), sdkmath.LegacyZeroDec()), true},
		{val, types.NewCommission(sdkmath.LegacyZeroDec(), sdkmath.LegacyNewDec(15000000000), sdkmath.LegacyZeroDec()), true},
		{val, types.NewCommission(sdk.NewDecWithPrec(-1, 1), sdkmath.LegacyZeroDec(), sdkmath.LegacyZeroDec()), true},
		{val, types.NewCommission(sdk.NewDecWithPrec(2, 1), sdk.NewDecWithPrec(1, 1), sdkmath.LegacyZeroDec()), true},
		{val, types.NewCommission(sdkmath.LegacyZeroDec(), sdkmath.LegacyZeroDec(), sdk.NewDecWithPrec(-1, 1)), true},
		{val, types.NewCommission(sdkmath.LegacyZeroDec(), sdk.NewDecWithPrec(1, 1), sdk.NewDecWithPrec(2, 1)), true},
	}
