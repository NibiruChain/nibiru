...
func InitializeNodeValidatorFiles(config *cmtcfg.Config) (nodeID string, valPubKey cryptotypes.PubKey, err error) {
...
func InitializeNodeValidatorFilesFromMnemonic(config *cmtcfg.Config, mnemonic string) (nodeID string, valPubKey cryptotypes.PubKey, err error) {
