...
import (
	...
	"github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/x/distribution/simulation"
	"github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/x/distribution/types" //nolint:staticcheck
...
func (suite *SimTestSuite) TestSimulateMsgWithdrawDelegatorReward() {
	...
	suite.distrKeeper.SetDelegatorStartingInfo(suite.ctx, validator0.GetOperator(), delegator.Address, distrtypes.NewDelegatorStartingInfo(2, sdkmath.LegacyOneDec(), 200))
...
func (suite *SimTestSuite) testSimulateMsgWithdrawValidatorCommission(tokenName string) {
	...
	valCommission := sdk.NewDecCoins(
		sdk.NewDecCoinFromDec(tokenName, sdkmath.LegacyNewDec(5).Quo(sdkmath.LegacyNewDec(2))),
		sdk.NewDecCoinFromDec("stake", sdkmath.LegacyNewDec(1).Quo(sdkmath.LegacyNewDec(1))),
	)
