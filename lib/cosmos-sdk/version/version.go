...
//
//	go build -X github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/version.Name=gaia \
//	 -X github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/version.AppName=gaiad \
//	 -X github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/version.Version=1.0 \
//	 -X github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/version.Commit=f0f7b7dab7e36c20b757cebce0e8f4fc5b95de60 \
//	 -X "github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk/version.BuildTags=linux darwin amd64"
package version
...
func getSDKVersion() string {
	...
	for _, dep := range deps.Deps {
		if dep.Path == "github.com/NibiruChain/nibiru/v2/lib/cosmos-sdk" {
