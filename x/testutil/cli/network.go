...
func DefaultConfig() Config {
	...
	return Config{
		...
		StartingTokens: sdk.NewCoins(
			sdk.NewCoin(common.StableDenom, sdk.TokensFromConsensusPower(1000, sdk.DefaultPowerReduction)),
			sdk.NewCoin(common.GovDenom, sdk.TokensFromConsensusPower(10000, sdk.DefaultPowerReduction)),
			sdk.NewCoin(common.CollDenom, sdk.TokensFromConsensusPower(1000, sdk.DefaultPowerReduction)),
			sdk.NewCoin(common.TestTokenDenom, sdk.TokensFromConsensusPower(10000, sdk.DefaultPowerReduction)),
		),
