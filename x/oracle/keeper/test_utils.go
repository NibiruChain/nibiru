...
var (
	...
	InitCoins  = sdk.NewCoins(sdk.NewCoin(common.DenomGov, InitTokens))
...
func CreateTestInput(t *testing.T) TestInput {
	...
	totalSupply := sdk.NewCoins(sdk.NewCoin(common.DenomGov, InitTokens.MulRaw(int64(len(Addrs)*10))))
	...
	stakingParams.BondDenom = common.DenomGov
	...
	bankKeeper.SendCoinsFromModuleToModule(ctx, faucetAccountName, stakingtypes.NotBondedPoolName, sdk.NewCoins(sdk.NewCoin(common.DenomGov, InitTokens.MulRaw(int64(len(Addrs))))))
	...
	for _, denom := range defaults.Whitelist {
		keeper.SetPair(ctx, denom.Name, denom.TobinTax)
	}
...
func NewTestMsgCreateValidator(address sdk.ValAddress, pubKey cryptotypes.PubKey, amt sdk.Int) *stakingtypes.MsgCreateValidator {
	...
	msg, _ := stakingtypes.NewMsgCreateValidator(
		address, pubKey, sdk.NewCoin(common.DenomGov, amt),
