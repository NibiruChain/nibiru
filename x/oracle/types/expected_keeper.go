...
type StakingKeeper interface {
	...
	Slash(context.Context, sdk.ConsAddress, int64, int64, math.LegacyDec) (math.Int, error) // slash the validator and delegators of the validator, specifying offense height, offense power, and slash fraction
	Jail(context.Context, sdk.ConsAddress) error                                            // jail a validator
	ValidatorsPowerStoreIterator(ctx context.Context) (corestore.Iterator, error)           // an iterator for the current validator power store
