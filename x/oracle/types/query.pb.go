...
type QueryActivesResponse struct {
	...
	Actives []github_com_NibiruChain_nibiru_x_common.AssetPair `protobuf:"bytes,1,rep,name=actives,proto3,customtype=github.com/NibiruChain/nibiru/x/common.AssetPair" json:"actives"`
}
...
type QueryVoteTargetsResponse struct {
	...
	VoteTargets []github_com_NibiruChain_nibiru_x_common.AssetPair `protobuf:"bytes,1,rep,name=vote_targets,json=voteTargets,proto3,customtype=github.com/NibiruChain/nibiru/x/common.AssetPair" json:"vote_targets"`
}
...
var fileDescriptor_812803c014dfa45a = []byte{
	...
	,
}
