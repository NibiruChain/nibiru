...
type QueryExchangeRateRequest struct {
	...
	Pair github_com_NibiruChain_nibiru_v2_x_nutil_asset.Pair `protobuf:"bytes,1,opt,name=pair,proto3,customtype=github.com/NibiruChain/nibiru/v2/x/nutil/asset.Pair" json:"pair"`
}
...
func (m *QueryExchangeRateResponse) GetBlockTimestampMs() int64 {
	if m != nil {
...
func (m *QueryExchangeRateResponse) GetBlockHeight() uint64 {
	if m != nil {
...
func (m *QueryExchangeRateResponse) GetIsVintage() bool {
	if m != nil {
		return m.IsVintage
	}
	return false
...
type QueryActivesResponse struct {
	...
	Actives []github_com_NibiruChain_nibiru_v2_x_nutil_asset.Pair `protobuf:"bytes,1,rep,name=actives,proto3,customtype=github.com/NibiruChain/nibiru/v2/x/nutil/asset.Pair" json:"actives"`
}
...
type QueryVoteTargetsResponse struct {
	...
	VoteTargets []github_com_NibiruChain_nibiru_v2_x_nutil_asset.Pair `protobuf:"bytes,1,rep,name=vote_targets,json=voteTargets,proto3,customtype=github.com/NibiruChain/nibiru/v2/x/nutil/asset.Pair" json:"vote_targets"`
}
...
var fileDescriptor_16aef2382d1249a8 = []byte{
	...
	,
}
...
func (m *QueryExchangeRateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsVintage", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *QueryActivesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_NibiruChain_nibiru_v2_x_nutil_asset.Pair
