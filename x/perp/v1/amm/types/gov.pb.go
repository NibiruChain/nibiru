...
type CreatePoolProposal struct {
	...
	// initialized with.
	QuoteReserve github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=quote_reserve,json=quoteReserve,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"quote_reserve"`
	// base_reserve is the amount of base asset the pool will be
	// initialized with.
	BaseReserve github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,6,opt,name=base_reserve,json=baseReserve,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"base_reserve"`
...
func (*CreatePoolProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_d77cd571cac2abbf, []int{0}
}
...
func (*EditPoolConfigProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_d77cd571cac2abbf, []int{1}
}
...
func (*EditSwapInvariantsProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_d77cd571cac2abbf, []int{2}
}
...
func (*EditSwapInvariantsProposal_SwapInvariantMultiple) Descriptor() ([]byte, []int) {
	return fileDescriptor_d77cd571cac2abbf, []int{2, 0}
}
...
func init() {
	proto.RegisterType((*CreatePoolProposal)(nil), "nibiru.perp.v1.amm.CreatePoolProposal")
	proto.RegisterType((*EditPoolConfigProposal)(nil), "nibiru.perp.v1.amm.EditPoolConfigProposal")
	proto.RegisterType((*EditSwapInvariantsProposal)(nil), "nibiru.perp.v1.amm.EditSwapInvariantsProposal")
	proto.RegisterType((*EditSwapInvariantsProposal_SwapInvariantMultiple)(nil), "nibiru.perp.v1.amm.EditSwapInvariantsProposal.SwapInvariantMultiple")
}

func init() { proto.RegisterFile("perp/v1/amm/gov.proto", fileDescriptor_d77cd571cac2abbf) }

var fileDescriptor_d77cd571cac2abbf = []byte{
	// 504 bytes of a gzipped FileDescriptorProto
	,
}
