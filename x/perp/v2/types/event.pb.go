...
type PositionChangedEvent struct {
	...
	ExchangedMargin github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,8,opt,name=exchanged_margin,json=exchangedMargin,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"exchanged_margin"`
...
func (m *PositionChangedEvent) GetChangeType() string {
	if m != nil {
		return m.ChangeType
	}
	return ""
...
var fileDescriptor_e18a1bd6d2374200 = []byte{
	...
	,
}
...
func (m *PositionChangedEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.ExchangedMargin.Size()
		i -= size
		if _, err := m.ExchangedMargin.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *PositionChangedEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExchangedMargin", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ExchangedMargin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
