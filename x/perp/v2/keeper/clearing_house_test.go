		...
		TC("existing long position, decrease a lot but there's bad debt").
			...
			Then(
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					TransactionFee:    sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 18), // 20 bps
					BlockHeight:       2,
	...
	tc := TestCases{
		TC("partial close long position with positive PnL").
			Given(
				...
				SetBlockTime(startBlockTime),
				SetBlockNumber(1),
				FundAccount(alice, sdk.NewCoins(sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.NewInt(10)))),
				InsertPosition(
					WithPair(pairBtcNusd),
					WithTrader(alice),
					WithSize(sdk.NewDec(10_000)),
		...
		TC("partial close long position with bad debt").
			...
			Then(
				...
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					BadDebt:           sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 27),
					FundingPayment:    sdk.NewDec(2),
		...
		TC("partial close short position with bad debt").
			...
			Then(
				...
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					BadDebt:           sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 48),
					FundingPayment:    sdk.NewDec(-2),
		...
		TC("close long position with positive PnL").
			...
			Then(
				...
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					BadDebt:           sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.ZeroInt()),
					FundingPayment:    sdk.NewDec(2),
					TransactionFee:    sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.NewInt(40)),
					BlockHeight:       1,
		...
		TC("close long position with bad debt").
			...
			Then(
				...
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					PositionNotional:  sdk.ZeroDec(),
					TransactionFee:    sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 18),
					RealizedPnl:       sdk.MustNewDecFromStr("-1100.000088999999110000"),
				...
				ModuleBalanceEqual(types.PerpEFModuleAccount, types.TestingCollateralDenomNUSD, sdk.NewInt(9)),
			),
		...
		TC("close short position with bad debt").
			...
			Then(
				...
				PositionChangedEventShouldBeEqual(&types.PositionChangedEvent{
					...
					PositionNotional:  sdk.ZeroDec(),
					TransactionFee:    sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 22),
					RealizedPnl:       sdk.MustNewDecFromStr("-1100.000111000001110000"),
					BadDebt:           sdk.NewInt64Coin(types.TestingCollateralDenomNUSD, 98),
					FundingPayment:    sdk.NewDec(-2),
					BlockHeight:       2,
				...
				ModuleBalanceEqual(types.PerpEFModuleAccount, types.TestingCollateralDenomNUSD, sdk.NewInt(11)),
			),
	}
	...
	tc := TestCases{
		...
		TC("long and short position - increasing k").
			...
			When(
				...
				ModuleBalanceShouldBeEqualTo(types.VaultModuleAccount, sdk.NewCoins(sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.NewInt(20_000_000_000)))),
			...
			Then(
				...
				ModuleBalanceShouldBeEqualTo(types.VaultModuleAccount, sdk.NewCoins()),
				ModuleBalanceShouldBeEqualTo(types.PerpEFModuleAccount, sdk.NewCoins(sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.NewInt(39_782_394)))),
			),
		TC("long and short position - reducing k").
			...
			Then(
				...
				ModuleBalanceShouldBeEqualTo(types.VaultModuleAccount, sdk.NewCoins()),
				ModuleBalanceShouldBeEqualTo(types.PerpEFModuleAccount, sdk.NewCoins(sdk.NewCoin(types.TestingCollateralDenomNUSD, sdk.NewInt(39_200_810)))),
			),
	}
