...
// QueryReserveAssetRequest is the request type for the reserve asset of the
// x/perp module account.
type QueryReserveAssetRequest struct {
}

func (m *QueryReserveAssetRequest) Reset()         { *m = QueryReserveAssetRequest{} }
func (m *QueryReserveAssetRequest) String() string { return proto.CompactTextString(m) }
func (*QueryReserveAssetRequest) ProtoMessage()    {}
func (*QueryReserveAssetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8212d8958be09421, []int{6}
}
func (m *QueryReserveAssetRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryReserveAssetRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryReserveAssetRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryReserveAssetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryReserveAssetRequest.Merge(m, src)
}
func (m *QueryReserveAssetRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryReserveAssetRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryReserveAssetRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryReserveAssetRequest proto.InternalMessageInfo

type QueryReserveAssetResponse struct {
}

func (m *QueryReserveAssetResponse) Reset()         { *m = QueryReserveAssetResponse{} }
func (m *QueryReserveAssetResponse) String() string { return proto.CompactTextString(m) }
func (*QueryReserveAssetResponse) ProtoMessage()    {}
func (*QueryReserveAssetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8212d8958be09421, []int{7}
}
func (m *QueryReserveAssetResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryReserveAssetResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryReserveAssetResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryReserveAssetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryReserveAssetResponse.Merge(m, src)
}
func (m *QueryReserveAssetResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryReserveAssetResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryReserveAssetResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryReserveAssetResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*QueryReserveAssetRequest)(nil), "nibiru.perp.v1.QueryReserveAssetRequest")
	proto.RegisterType((*QueryReserveAssetResponse)(nil), "nibiru.perp.v1.QueryReserveAssetResponse")
}
...
var fileDescriptor_8212d8958be09421 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	ReserveAsset(ctx context.Context, in *QueryReserveAssetRequest, opts ...grpc.CallOption) (*QueryReserveAssetResponse, error)
}
...
func (c *queryClient) ReserveAsset(ctx context.Context, in *QueryReserveAssetRequest, opts ...grpc.CallOption) (*QueryReserveAssetResponse, error) {
	out := new(QueryReserveAssetResponse)
	err := c.cc.Invoke(ctx, "/nibiru.perp.v1.Query/ReserveAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	ReserveAsset(context.Context, *QueryReserveAssetRequest) (*QueryReserveAssetResponse, error)
}
...
func (*UnimplementedQueryServer) ReserveAsset(ctx context.Context, req *QueryReserveAssetRequest) (*QueryReserveAssetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReserveAsset not implemented")
}
...
func _Query_ReserveAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryReserveAssetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ReserveAsset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nibiru.perp.v1.Query/ReserveAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ReserveAsset(ctx, req.(*QueryReserveAssetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_ReserveAsset_Handler,
		},
	},
...
func (m *QueryReserveAssetRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryReserveAssetRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryReserveAssetRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryReserveAssetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryReserveAssetResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryReserveAssetResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryReserveAssetRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryReserveAssetResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryReserveAssetRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryReserveAssetRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryReserveAssetRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryReserveAssetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryReserveAssetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryReserveAssetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
