...
var (
	...
	ErrPairMetadataNotFound              = sdkerrors.Register(ModuleName, 3, "pair doesn't have metadata")
	ErrPositionZero                      = sdkerrors.Register(ModuleName, 4, "position is zero")
	ErrFailedRemoveMarginCanCauseBadDebt = sdkerrors.Register(ModuleName, 5, "failed to remove margin; position would have bad debt if removed")
	ErrQuoteAmountIsZero                 = sdkerrors.Register(ModuleName, 6, "quote amount cannot be zero")
	ErrLeverageIsZero                    = sdkerrors.Register(ModuleName, 7, "leverage cannot be zero")
	ErrMarginRatioTooLow                 = sdkerrors.Register(ModuleName, 8, "margin ratio did not meet maintenance margin ratio")
	ErrLeverageIsTooHigh                 = sdkerrors.Register(ModuleName, 9, "leverage cannot be higher than vpool parameter")
)
