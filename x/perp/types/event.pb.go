...
type FundingRateChangedEvent struct {
	// The latest funding rate calculated.
	LatestFundingRate github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=latest_funding_rate,json=latestFundingRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"latest_funding_rate"`
	...
	CumulativeFundingRate github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=cumulative_funding_rate,json=cumulativeFundingRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"cumulative_funding_rate"`
}
...
var fileDescriptor_19b7f9ebcf2fdb5b = []byte{
	...
	,
}
