...
type MsgAddMarginResponse struct {
	MarginAdded    types.Coin                             `protobuf:"bytes,1,opt,name=margin_added,json=marginAdded,proto3" json:"margin_added"`
	FundingPayment github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"funding_payment"`
...
func (m *MsgAddMarginResponse) GetMarginAdded() types.Coin {
	if m != nil {
		return m.MarginAdded
	}
	return types.Coin{}
}
...
var fileDescriptor_28f06b306d51dcfb = []byte{
	...
	,
}
...
func (m *MsgAddMarginResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	{
		size, err := m.MarginAdded.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgAddMarginResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarginAdded", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MarginAdded.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
