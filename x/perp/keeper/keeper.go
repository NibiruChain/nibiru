...
type Keeper struct {
	...
	Whitelist      collections.KeySet[keys.StringKey]
...
func NewKeeper(
	...
	return Keeper{
		...
		Positions:       collections.NewMap[keys.Pair[common.AssetPair, keys.StringKey], types.Position](cdc, storeKey, 1),
		Whitelist:       collections.NewKeySet[keys.StringKey](cdc, storeKey, 2),
