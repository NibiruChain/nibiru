...
func NewKeeper(
	...
	return Keeper{
		...
		PrepaidBadDebt: collections.NewMap[string, types.PrepaidBadDebt](storeKey, 2, collections.StringKeyEncoder, collections.ProtoValueEncoder[types.PrepaidBadDebt](cdc)),
	}
}
