			...
			given: func(ctx sdk.Context, mocks mockedDependencies, perpKeeper Keeper) {
				...
				mocks.mockPerpAmmKeeper.EXPECT().
					SwapQuoteForBase(
						ctx,
						market,
						/*quoteAssetDirection=*/ v2types.Direction_LONG,
			...
			given: func(ctx sdk.Context, mocks mockedDependencies, perpKeeper Keeper) {
				...
				mocks.mockPerpAmmKeeper.EXPECT().
					SwapQuoteForBase(
						ctx,
						market,
						/*quoteAssetDirection=*/ v2types.Direction_SHORT,
						/*quoteAssetAmount=*/ sdk.NewDec(100),
...
func TestDecreasePosition(t *testing.T) {
	tests := []struct {
		...
		quoteAssetDir         v2types.Direction
	...
	}{
		{
			...
			quoteAssetDir:         v2types.Direction_SHORT,
		...
		/*==========================SHORT POSITIONS===========================*/
		{
			...
			priorPositionNotional: sdk.NewDec(100),
			quoteAssetDir:         v2types.Direction_LONG,
			quoteAmountToDecrease: sdk.NewDec(5),
			exchangedBaseAmount:   sdk.MustNewDecFromStr("5.25"),
			baseAssetLimit:        sdk.MustNewDecFromStr("5.25"),
...
func TestCloseAndOpenReversePosition(t *testing.T) {
	tests := []struct {
		...
		mockBaseDir     v2types.Direction
		mockQuoteAmount sdk.Dec
		mockQuoteDir    v2types.Direction
		...
		expectedPositionResp v2types.PositionResp
		...
		/*==========================LONG POSITIONS============================*/
		{
			...
			mockBaseDir:     v2types.Direction_LONG,
			mockQuoteAmount: sdk.NewDec(200),
			mockQuoteDir:    v2types.Direction_SHORT,
		...
		/*==========================SHORT POSITIONS===========================*/
		{
			...
			mockBaseDir:     v2types.Direction_SHORT,
			mockQuoteAmount: sdk.NewDec(100),
			mockQuoteDir:    v2types.Direction_LONG,
