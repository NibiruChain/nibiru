...
func TestKeeper_GetMarginRatio_Errors(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := k.GetMarginRatio(ctx, pos, types.MarginCalculationPriceOption_MAX_PNL)
...
func TestKeeper_GetMarginRatio(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			marginRatio, err := k.GetMarginRatio(ctx, tc.position, types.MarginCalculationPriceOption_MAX_PNL)
