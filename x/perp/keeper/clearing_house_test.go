...
func TestOpenPosition(t *testing.T) {
	testCases := []struct {
		...
		{
			name:                 "success - new long position",
		...
		{
			name:        "success - existing long position, go more long",
			traderFunds: sdk.NewCoins(sdk.NewInt64Coin(common.DenomStable, 1020)),
			initialPosition: &types.Position{
		...
		{
			name:        "success - existing long position, decrease a bit",
		...
		{
			name:        "success - existing long position, decrease a lot",
		...
		{
			name:        "success - existing short position, go more short",
			traderFunds: sdk.NewCoins(sdk.NewInt64Coin(common.DenomStable, 1020)),
			initialPosition: &types.Position{
				Pair:                                common.PairBTCStable,
				Size_:                               sdk.NewDec(-10_000),
		...
		{
			name:        "success - existing short position, decrease a bit",
			traderFunds: sdk.NewCoins(sdk.NewInt64Coin(common.DenomStable, 10)),
			initialPosition: &types.Position{
				Pair:                                common.PairBTCStable,
				Size_:                               sdk.NewDec(-10_000),
		...
		{
			name:        "success - existing short position, decrease a lot",
			traderFunds: sdk.NewCoins(sdk.NewInt64Coin(common.DenomStable, 1060)),
			initialPosition: &types.Position{
				Pair:                                common.PairBTCStable,
				Size_:                               sdk.NewDec(-10_000),
