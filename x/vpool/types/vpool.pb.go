...
type PoolPrices struct {
	...
	MarkPrice *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,10,opt,name=mark_price,json=markPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"mark_price,omitempty"`
	// IndexPrice is the price of the "underlying" for the perp
	IndexPrice *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,11,opt,name=index_price,json=indexPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"index_price,omitempty"`
	// TwapMark is the time-weighted average (mark) price.
	TwapMark *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,12,opt,name=twap_mark,json=twapMark,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"twap_mark,omitempty"`
	// SwapInvariant is the product of the reserves, commonly referred to as "k".
	SwapInvariant *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,13,opt,name=swap_invariant,json=swapInvariant,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"swap_invariant,omitempty" yaml:"swap_invariant"`
...
var fileDescriptor_eb4ac691d1b54d04 = []byte{
	...
	,
}
