	...
	vpools := []types.Vpool{
		{
			...
			BaseAssetReserve:  sdk.NewDec(1 * common.MICRO),      // 1
			QuoteAssetReserve: sdk.NewDec(30_000 * common.MICRO), // 30,000
			SqrtDepth:         common.MustSqrtDec(sdk.NewDec(30_000 * common.MICRO * common.MICRO)),
		...
		},
		{
			...
			BaseAssetReserve:  sdk.NewDec(2 * common.MICRO),      // 2
			QuoteAssetReserve: sdk.NewDec(60_000 * common.MICRO), // 60,000
			SqrtDepth:         common.MustSqrtDec(sdk.NewDec(2 * 60_000 * common.MICRO * common.MICRO)),
			Config: types.VpoolConfig{
