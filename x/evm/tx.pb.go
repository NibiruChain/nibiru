...
type MsgConvertEvmToCoin struct {
	...
	Erc20ContractAddress github_com_NibiruChain_nibiru_v2_eth.EIP55Addr `protobuf:"bytes,2,opt,name=erc20_contract_address,json=erc20ContractAddress,proto3,customtype=github.com/NibiruChain/nibiru/v2/eth.EIP55Addr" json:"erc20_contract_address"`
...
func (m *MsgConvertEvmToCoin) GetToAddress() string {
	if m != nil {
		return m.ToAddress
	}
	return ""
...
var fileDescriptor_82a0bfe4f0bab953 = []byte{
	...
	,
}
...
func (m *MsgConvertEvmToCoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	{
		size := m.Erc20ContractAddress.Size()
		i -= size
		if _, err := m.Erc20ContractAddress.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *MsgConvertEvmToCoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Erc20ContractAddress.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
