...
type MsgCreateFunToken struct {
	...
	FromErc20 *github_com_NibiruChain_nibiru_v2_eth.HexAddr `protobuf:"bytes,1,opt,name=from_erc20,json=fromErc20,proto3,customtype=github.com/NibiruChain/nibiru/v2/eth.HexAddr" json:"from_erc20,omitempty"`
...
type MsgSendFunTokenToEvm struct {
	// Hexadecimal address of the ERC20 token to which the `FunToken` maps
	ToEthAddr github_com_NibiruChain_nibiru_v2_eth.HexAddr `protobuf:"bytes,1,opt,name=to_eth_addr,json=toEthAddr,proto3,customtype=github.com/NibiruChain/nibiru/v2/eth.HexAddr" json:"to_eth_addr"`
	// Sender: Address for the signer of the transaction.
...
var fileDescriptor_82a0bfe4f0bab953 = []byte{
	...
	,
}
...
func (m *MsgCreateFunToken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_NibiruChain_nibiru_v2_eth.HexAddr
			m.FromErc20 = &v
