...
func (s *Suite) TestInsertAndGet() {
	...
	s.Require().NoError(err)
	s.Require().Equal(gethcommon.HexToAddress("0xAEf9437FF23D48D73271a41a8A094DEc9ac71477"), gethcommon.HexToAddress(funToken.Erc20Addr))
...
func (s *Suite) TestCollect() {
	...
	s.Require().Equal(gethcommon.HexToAddress("0xAEf9437FF23D48D73271a41a8A094DEc9ac71477"), gethcommon.HexToAddress(funTokens[0].Erc20Addr))
