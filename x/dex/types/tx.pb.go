...
type MsgSwapAssets struct {
	Sender        string     `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	PoolId        uint64     `protobuf:"varint,2,opt,name=poolId,proto3" json:"poolId,omitempty" yaml:"pool_id"`
	TokensIn      types.Coin `protobuf:"bytes,3,opt,name=tokensIn,proto3" json:"tokensIn" yaml:"tokens_in"`
...
func (m *MsgSwapAssets) GetTokensIn() types.Coin {
	if m != nil {
		return m.TokensIn
	}
	return types.Coin{}
...
type MsgSwapAssetsResponse struct {
	TokensOut types.Coin `protobuf:"bytes,3,opt,name=tokensOut,proto3" json:"tokensOut" yaml:"tokens_out"`
}
...
func (m *MsgSwapAssetsResponse) GetTokensOut() types.Coin {
	if m != nil {
		return m.TokensOut
	}
	return types.Coin{}
...
var fileDescriptor_18e8aa85ff669608 = []byte{
	...
	,
}
...
func (m *MsgSwapAssets) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.TokensIn.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgSwapAssetsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.TokensOut.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgSwapAssets) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.TokensIn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *MsgSwapAssetsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.TokensOut.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
