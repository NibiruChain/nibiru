...
// Returns the spot price of token1 / token0.
// For example, if the price of NIBI was 10 NUSD, then sending token1Denom=NUSD
// and token0Denom=NIBI, you would get 10NUSD as the answer (since its 10NUSD/1NIBI).
type QuerySpotPriceRequest struct {
	PoolId uint64 `protobuf:"varint,1,opt,name=poolId,proto3" json:"poolId,omitempty"`
	// numerator denomination
	Token1Denom string `protobuf:"bytes,2,opt,name=token1Denom,proto3" json:"token1Denom,omitempty"`
	// denominator denomination
	Token0Denom string `protobuf:"bytes,3,opt,name=token0Denom,proto3" json:"token0Denom,omitempty"`
}
...
func (m *QuerySpotPriceRequest) GetToken1Denom() string {
	if m != nil {
		return m.Token1Denom
	}
	return ""
}

func (m *QuerySpotPriceRequest) GetToken0Denom() string {
	if m != nil {
		return m.Token0Denom
	}
	return ""
}
...
var fileDescriptor_4ba1e1ef24357ddf = []byte{
	...
	,
}
...
func (m *QuerySpotPriceRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Token0Denom) > 0 {
		i -= len(m.Token0Denom)
		copy(dAtA[i:], m.Token0Denom)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Token0Denom)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Token1Denom) > 0 {
		i -= len(m.Token1Denom)
		copy(dAtA[i:], m.Token1Denom)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Token1Denom)))
		i--
		dAtA[i] = 0x12
	}
	if m.PoolId != 0 {
...
func (m *QuerySpotPriceRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Token1Denom", wireType)
			}
			...
			m.Token1Denom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Token0Denom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Token0Denom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
