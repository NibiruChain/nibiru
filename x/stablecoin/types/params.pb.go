...
type Params struct {
	CollRatio uint64 `protobuf:"varint,1,opt,name=collRatio,proto3" json:"collRatio,omitempty"`
}
...
func (m *Params) GetCollRatio() uint64 {
	if m != nil {
		return m.CollRatio
	}
	return 0
...
var fileDescriptor_f563aa317ffb7645 = []byte{
	...
	0xca, 0x95, 0xd4, 0xb8, 0xd8, 0x02, 0xc0, 0xda, 0x85, 0x64, 0xb8, 0x38, 0x93, 0xf3, 0x73, 0x72,
	0x82, 0x12, 0x4b, 0x32, 0xf3, 0x25, 0x18, 0x15, 0x18, 0x35, 0x58, 0x82, 0x10, 0x02, 0x4e, 0x1e,
	...
	0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0xb7, 0x5b, 0x3f, 0x17, 0xcc, 0xd2, 0xaf, 0xd0, 0x47,
	0x72, 0x67, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0x62, 0x63, 0x40, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xbb, 0x2f, 0x93, 0xd2, 0xc2, 0x00, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CollRatio |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
