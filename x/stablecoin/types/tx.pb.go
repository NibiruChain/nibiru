...
//
//MsgMintStable: Msg to mint USDM. A user deposits NIBI and collateral and gets
...
//
//MsgBurnStable allows users to burn USDM in exchange for NIBI and collateral in return. The amount of NIBI and
