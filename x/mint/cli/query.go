...
func GetPeriod() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			queryClient := mint.NewQueryClient(clientCtx)

			params := &mint.QueryPeriodRequest{}
...
func GetEpochMintProvision() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			req := &mint.QueryEpochMintProvisionRequest{}
...
func GetSkippedEpochs() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			req := &mint.QuerySkippedEpochsRequest{}
...
func GetCirculatingSupply() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			req := &mint.QueryCirculatingSupplyRequest{}
...
func GetInflationRate() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			req := &mint.QueryInflationRateRequest{}
