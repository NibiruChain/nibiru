...
func (s *SuiteInflationSudo) TestMergeInflationParams() {
	currentParams := mint.DefaultParams()

	newEpochsPerPeriod := sdkmath.NewInt(4)
	paramsChanges := mint.MsgEditInflationParams{
	...
	newInflationDistribution := mint.InflationDistribution{
...
func (s *SuiteInflationSudo) TestEditInflationParams() {
	...
	msgEditParams := mint.MsgEditInflationParams{
