...
func (k Keeper) MintCoins(ctx sdk.Context, coin sdk.Coin) error {
	...
	return k.bankKeeper.MintCoins(ctx, mint.ModuleName, coins)
}
...
func (k Keeper) AllocatePolynomialInflation(
	...
	inflationModuleAddr := k.accountKeeper.GetModuleAddress(mint.ModuleName)
	...
	if err = k.bankKeeper.SendCoinsFromModuleToAccount(
		ctx, mint.ModuleName, strategicAccountAddr, sdk.NewCoins(strategic),
	); err != nil {
	...
	return staking, strategic, community, ctx.EventManager().EmitTypedEvents(
		&mint.EventInflationDistribution{
...
func (k Keeper) GetEpochMintProvision(ctx sdk.Context) sdkmath.LegacyDec {
	...
	return mint.CalculateEpochMintProvision(
		k.GetParams(ctx),
		peek,
	)
}
