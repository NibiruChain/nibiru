...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "price"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Prices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "prices"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RawPrices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "raw_prices"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Oracles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "oracles"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Markets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"MatrixDAO", "dex", "pricefeed", "markets"}, "", runtime.AssumeColonVerbOpt(true)))
)
