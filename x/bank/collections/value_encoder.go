...
// SignedInt Value ValueEncoder[SignedInt]

var SignedIntValueEncoder ValueEncoder[sdkmath.Int] = signedIntEncoder{}

type signedIntEncoder struct{}

// Encode encodes the value T into bytes.
// Encode(value T) []byte
func (signedIntEncoder) Encode(v sdkmath.Int) []byte {
	bz, err := v.Marshal()
	if err != nil {
...
// Decode(b []byte) T
func (signedIntEncoder) Decode(bz []byte) sdkmath.Int {
	n := new(sdkmath.Int)
	err := n.Unmarshal(bz)
	if err != nil {
...
func (signedIntEncoder) Stringify(v sdkmath.Int) string {
	return v.String()
}

// Name returns the name of the object.
func (signedIntEncoder) Name() string {
