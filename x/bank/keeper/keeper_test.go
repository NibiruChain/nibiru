...
func (suite *KeeperTestSuite) SetupTest() {
	...
	tkey := sdk.NewTransientStoreKey(keeper.StoreKeyTransient)
...
func (suite *KeeperTestSuite) TestGetAuthority() {
	NewKeeperWithAuthority := func(authority string) keeper.BaseKeeper {
		return keeper.NewBaseKeeper(
			...
			sdk.NewTransientStoreKey(keeper.StoreKeyTransient),
			nil,
			nil,
			authority,
		)
...
func (suite *KeeperTestSuite) TestSendEnabled() {
	...
	bondCoin := sdk.NewCoin(sdk.DefaultBondDenom, sdkmath.OneInt())
	fooCoin := sdk.NewCoin("foocoin", sdkmath.OneInt())
	barCoin := sdk.NewCoin("barcoin", sdkmath.OneInt())
