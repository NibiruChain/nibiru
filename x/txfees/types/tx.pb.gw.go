...
var (
	pattern_Msg_UpdateFeeToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"nibiru", "txfees", "v1", "update_fee_token"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_UpdateParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"nibiru", "txfees", "v1", "update_params"}, "", runtime.AssumeColonVerbOpt(false)))
)
