...
export interface ERC20MinterWithMetadataUpdatesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC20MinterWithMetadataUpdates extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20MinterWithMetadataUpdates
  waitForDeployment(): Promise<this>

  interface: ERC20MinterWithMetadataUpdatesInterface
