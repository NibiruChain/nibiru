...
Example:
	nibid testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(server.FlagMinGasPrices, fmt.Sprintf("0.000006%s", sdk.DefaultBondDenom), "Minimum gas prices to accept for transactions; KeyValues fees in a tx must meet this minimum (e.g. 0.01photino,0.001stake)")
