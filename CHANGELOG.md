...
* [#1267](https://github.com/NibiruChain/nibiru/pull/1267) - refactor(proto)!: lint protos and standardize versioning
* [#1270](https://github.com/NibiruChain/nibiru/pull/1270) - refactor(perp)!: (1/2) Moves types, keeper, and cli from vpool to perp/amm
