...
- [#2394](https://github.com/NibiruChain/nibiru/pull/2394) - feat(proto): REST API doc generation for bank, auth, and txs
...
- [#2413](https://github.com/NibiruChain/nibiru/pull/2413) - refactor(upgrades-rpc): simplify upgrade hanlder code to use less abstractions and combine micro-packages
